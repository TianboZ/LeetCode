...
//    }
//
//    public void dfs(int[] arr, int index, List<Integer> path, List<List<Integer>> res, int k, int[] remain) {
//        // base-case
////        if (found) {
////            return;
////        }
...
//            }
//        }
//        if (sum == 0 && path.size() == arr.length * 2) {
...
//        for (int i = 0; i < arr.length; i++) {
//            int num = arr[i];
//            int lastIndex = path.lastIndexOf(num);
//            if (lastIndex == -1) {
//                // not exist
//                path.add(num);
//                remain[i]--;
//                dfs(arr, index + 1, path, res, k, remain);
//                remain[i]++;
