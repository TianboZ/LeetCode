...
//        Map<String, Cell> used = new HashMap<>();
//
//        // use treeset to sort every recommend, keep it size is k
//        TreeSet<Cell> recommend = new TreeSet<>(new CP());
//
//        buildCategoryMap(categories, map);
...
//            TreeSet<Cell> relevants = map.get(proj);
//
//            // add itself to the recommends
//            update(recommend, used,  (float)1.0,  proj);
//
//            // for loop each current project's recommendation
//            for (Cell relevant : relevants) {
//                update(recommend, used, relevant.score, relevant.cate);
...
//            sol[i] = new String[res.get(i).size()];
//            for (int j = 0; j < res.get(i).size(); j++) {
//                sol[i][j] = res.get(i).get(j);
//            }
//        }
...
//
//
//    private void update(TreeSet<Cell> recommend, Map<String, Cell> used, float score, String cate) {
//        // check cate if has been recommended before
//        if (used.containsKey(cate)) {
//            // cate is recommended before, if new cate with higher score, should update old cate's score
//            if (used.get(cate).score < score) {
//                // should update
...
//            String s1 = arr[0];
//            String s2 = arr[1];
//            float score = Float.valueOf(arr[2]);
//
//            TreeSet<Cell> set = map.get(s1);
//            if (set == null) {
//                set = new TreeSet<>(new CP());
...
//        public int compare(Cell c1, Cell c2) {
//            if (c1.score == c2.score) {
//                return c1.cate.compareTo(c2.cate);
//            } else {
...
//    }
    ...
    public static void main(String[] args) {
        //TreeSet<Cell> set = new TreeSet<>(new CP());
//        set.add(new Cell("house painting", (float) 1.0));
//        set.add(new Cell("interior painting", (float) 0.9));
//        //set.add(new Cell("interior painting", (float) 0.99));
//        set.add(new Cell("xyz painting", (float) 1.0));
//        set.add(new Cell("xyz painting", (float) 1.0));
//        set.remove(new Cell("interior painting", (float) 0.9));
        ...
        thumbtack.categorySuggestions(category, projects, 5);
